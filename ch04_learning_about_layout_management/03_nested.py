...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        food_como1 = QComboBox()
        food_como1.addItems(food_list)
        # food_como1.currentIndexChanged.connect(self.comboxChanged)

        food_como2 = QComboBox()
        food_como2.addItems(food_list)
        ...
        # Create two horizontal layouts for the ComboBox
        # and QSpinBox widgets
        item1_h_box = QHBoxLayout()
        item1_h_box.addWidget(food_como1)
        item1_h_box.addWidget(self.price_sb1)

        item2_h_box = QHBoxLayout()
        item2_h_box.addWidget(food_como2)
