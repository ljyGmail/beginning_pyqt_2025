...
image_path = "ch07_handling_events_in_pyqt/images"
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        self.image_label.setPixmap(QPixmap(f"{image_path}/back.png"))
    ...
    def enterEvent(self, event):
        self.image_label.setPixmap(QPixmap(f"{image_path}/front.png"))
    ...
    def mouseDoubleClickEvent(self, event):
        self.image_label.setPixmap(QPixmap(f"{image_path}/boom.png"))
