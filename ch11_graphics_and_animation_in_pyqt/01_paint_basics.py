...
class MainWindow(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter = QPainter()  # Construct the painter object
        painter.begin(self)
        # Use anti-aliasing to smmoth curved edges
    ...
    def drawPolygons(self, painter):
        ...
        points = QPolygon(
            [QPoint(240, 240), QPoint(380, 250), QPoint(230, 380), QPoint(370, 360)]
        )
    ...
    def drawRoundedRects(self, painter):
        """Examples of how to draw rectangles with
        rounded cornets with QPainter."""
        pen = QPen(QColor(self.black))
        brush = QBrush(QColor(self.black))

        rect_1 = QRect(420, 340, 40, 60)
        rect_2 = QRect(480, 300, 50, 30)
