...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        ...
        self.new_act = QAction(QIcon(f"{image_path}/new_file.png"), "New")
        self.new_act.setShortcut("Ctrl+N")
        self.new_act.triggered.connect(self.clearText)

        self.open_act = QAction(QIcon(f"{image_path}/open_file.png"), "Open")
        self.open_act.setShortcut("Ctrl+O")
        self.open_act.triggered.connect(self.openFile)

        self.save_act = QAction(QIcon(f"{image_path}/save_file.png"), "Save")
