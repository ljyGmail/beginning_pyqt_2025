...
class MainWindow(QMainWindow):
    ...
    def createToolsDockWidget(self):
        ...
        Edit Image Tools menu to show/hide the dock."""
    ...
    def createActions(self):
        ...
        self.print_act = QAction(QIcon(f"{image_path}/print.png"), "Print")
        ...
        self.rotate90_act.setStatusTip("Rootate image 90° clockwise")
        self.rotate90_act.triggered.connect(self.rotateImage90)

        self.rotate180_act = QAction("Rotate 180°")
        self.rotate180_act.setStatusTip("Rootate image 180° clockwise")
        ...
        self.clear_act = QAction(QIcon(f"{image_path}/clear.png"), "Clear Image")
