...
class StickyNote(QMainWindow):
    ...
    def createActions(self):
        ...
        self.clear_act.setShortcut("Ctrl+W")
        self.clear_act.triggered.connect(self.clearNote)
    ...
    def createMenu(self):
        ...
        # Create Clor menu and add actions
    ...
    def newNote(self):
        """Create new instance of StickNote class."""
        StickyNote().show()
        self.note_id += 1
