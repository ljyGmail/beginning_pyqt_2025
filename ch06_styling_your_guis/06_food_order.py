...
class MainWindow(QWidget):
    ...
    def pizzaTab(self):
        ...
        pizza_image_path = "ch06_styling_your_guis/images/pizza.png"
        ...
        pizza_desc.setText(
            ...
            the prefect amout of cheese and sauce.</p>"""
        )
        ...
        # Create group box that will contain curst choices
        ...
        # Create radio buttons for the different cursts and
        # add to layout
    ...
    def wingsTab(self):
        ...
        description_box = QWidget()
        description_box.setObjectName("ImageBorder")
        wings_image_path = "ch06_styling_your_guis/images/wings.png"
        wings_image = self.loadImage(wings_image_path)
        wings_desc = QLabel()
        wings_desc.setObjectName("ImageInfo")
        wings_desc.setText(
            """<p>6 pieces of rich-tasting, while meat
