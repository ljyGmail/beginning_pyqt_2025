...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        about_label.setText(
            "I'm a Software Engineer with 10 years\
    ...
    def createImageLabels(self):
        ...
        images = [
            "ch02_building_a_simple_gui/images/skyblue.png",
            "ch02_building_a_simple_gui/images/profile_image.png",
        ]
        ...
        for image in images:
            try:
                with open(image):
                    ...
                    if image == "ch02_building_a_simple_gui/images/profile_image.png":
                        label.move(75, 20)
